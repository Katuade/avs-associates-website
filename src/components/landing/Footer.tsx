        ...
        <div className="grid grid-cols-1 gap-8 text-center md:col-span-2 md:grid-cols-1 md:text-left">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            ...
            <div className="flex flex-col items-center gap-2 md:items-start">
              ...
              <p className="text-sm text-foreground/80">(123) 456-7890</p>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div className="flex flex-col items-center gap-2 md:items-start">
            ...
            <div className="flex flex-col items-center gap-2 md:items-start">
              ...
              <div className="flex gap-4">
                ...
                <Link href="#" prefetch={false}>
                  <Instagram className="h-6 w-6 text-foreground/60 transition-colors hover:text-foreground" />
                  <span className="sr-only">Instagram</span>
                </Link>
                <Link href="#" prefetch={false}>
                  <Facebook className="h-6 w-6 text-foreground/60 transition-colors hover:text-foreground" />
